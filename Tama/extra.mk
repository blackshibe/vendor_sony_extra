...
TARGET_SHIPS_APERTURE_CAMERA ?= false
...
# Sony Camera
ifeq ($(TARGET_SHIPS_APERTURE_CAMERA),true)
    $(call inherit-product, vendor/sony/extra/Tama/camera/camera.mk)
endif
...
ifeq ($(TARGET_SHIPS_SOUND_ENHANCEMENT),true)
    $(call inherit-product, vendor/sony/extra/Tama/audio/dolby/dolby.mk)
endif
